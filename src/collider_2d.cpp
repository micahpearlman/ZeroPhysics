...
bool  Collider2dImpl::isSensor() const {}
void  Collider2dImpl::setFriction(float friction) {}
float Collider2dImpl::friction() const {}
void  Collider2dImpl::setRestitution(float restitution) {}
float Collider2dImpl::restitution() const {}
...
collider_handle_2d_t     Collider2dImpl::handle() const {}
Collider2d::ColliderType Collider2dImpl::type() const {}

Collider2dImpl::Data &Collider2dImpl::data();
const Collider2dImpl::Data           &Collider2dImpl::Collider2dImpl::data() const;
